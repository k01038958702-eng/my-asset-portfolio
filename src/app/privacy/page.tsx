  ...
  return (
    <div className="legal-page">
      ...
      <main className="legal-main">
        ...
        <div className="legal-operator-info"><div><b>운영자</b><span>richchoi_studio</span></div><div><b>개인정보 보호 담당</b><span>richchoi_studio</span></div><div><b>문의 연락처</b><span>정식 공개 전 확정 예정</span></div></div>
        ...
        <section><h2>5. 이용자의 권리</h2><p>회원은 서비스 화면에서 자신의 정보를 조회·수정·삭제할 수 있으며, 계정 관리에서 계정과 저장 데이터를 삭제할 수 있습니다. 개인정보 처리 관련 문의 연락처는 정식 배포 전 이 페이지에 표시합니다.</p></section>
